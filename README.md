...
**Please note that this project is now [part](https://github.com/bkahlert/kommons/tree/master/kommons-debug) of
the [Kommons](https://github.com/bkahlert/kommons) library.**
